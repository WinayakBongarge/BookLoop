...
const navItems = [
    ...
    { name: 'Messages', icon: 'chat', view: 'messages' },
];
    ...
    return (
        <aside className="hidden md:flex flex-col w-64 bg-surface shadow-lg fixed top-0 left-0 h-full z-30">
            <div className="flex items-center justify-center h-20 border-b border-neutral-medium">
                <h1 className="text-3xl font-montserrat font-bold text-primary">BookLoop</h1>
            </div>
            <nav className="flex-1 px-4 py-6 space-y-1">
                {navItems.map(item => (
                    <a
                        ...
                        className={`flex items-center px-4 py-3 rounded-full transition-colors text-base font-montserrat font-medium ${
